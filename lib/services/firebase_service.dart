...
class FirebaseService {
  ...
  Future<void> populateDummyData() async {
    ...
    if (snapshot.docs.length < 11) {
      print('Firebase: Ürün sayısı yetersiz (${snapshot.docs.length}), yeniden popüle ediliyor...');
      // Mevcut verileri temizle (eskiden kalan az sayıdaki ürünü siler)
      ...
      print('Firebase: 11 farklı ürün başarıyla eklendi.');
    } else {
      print('Firebase: Ürünler zaten mevcut (${snapshot.docs.length} adet).');
    }
  }
}
